          ...
          <div className="flex flex-col justify-start items-start gap-2">
            ...
            <ul>
              ...
              <li>
                ...
                in this Agreement) refers to IS GREED GOOD.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to IS GREED GOOD, accessible
                from{" "}
                <a
                  href="https://is-greed-good.vercel.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://is-greed-good.vercel.app/
                </a>
              </li>
              <li>
            ...
            <ul>
              <li>By email: kaleb.is.caleb@gmail.com</li>
            </ul>
          </div>
        </div>
      </Window>
